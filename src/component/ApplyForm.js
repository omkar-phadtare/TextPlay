...
<>
<h1 className='text-center title-font'>Testing React Js</h1>
  ...
  <div className="col-md-4">
    ...
    <input type="text" className="form-control" id="validationCustom01" onChange={handleFirstName} value={first} required />
  ...
  <div className="col-md-4">
    ...
    <input type="text" className="form-control" id="validationCustom02" onChange={handleLastName} value={last} required />
    <div className="valid-feedback">
      Looks good!
    </div>
  </div>
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" onChange={onChangeTextArea} value={text} rows="3"></textarea>
    <div className="invalid-feedback">
  ...
  <div className="col-md-3">
    ...
    <select className="form-select" id="validationCustom04" defaultValue={props.select} required>
  ...
  <div className="col-12">
    <button className="btn btn-secondary" onClick={handleUpClick}>Submit form</button>
  </div>
</form>
</div>
